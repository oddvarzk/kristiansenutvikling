...
export default function KrageroNatursteinPage() {
  ...
  const content = isEn
    ? { subtitle: "Natural Stone Supplier", description: "A professional website built for Kragero Naturstein, a Norwegian natural stone supplier. The site presents their product range, services and contact information in a clean and modern design suited to their brand.", gallery: "Gallery", technologies: "Technologies" }
    : { subtitle: "Natursteinssleverandør", description: "En profesjonell nettside bygget for Kragero Naturstein, en norsk leverandør av naturstein. Siden presenterer produktutvalget, tjenester og kontaktinformasjon i et rent og moderne design tilpasset merkevaren.", gallery: "Bildegalleri", technologies: "Teknologier brukt" };
