...
export default function FeaturedProjects() {
  ...
  const projects: Project[] = isEn
    ? [
        { id: "holidaze",           title: "Holidaze",           description: "Modern booking platform for holiday homes with interactive maps.", href: "/en/prosjekter/holidaze",          image: "/images/projects/holidazeHome.png", video: null,                                  placeholder: "#131313",  tag: "React / TypeScript",     year: "2024" },
        { id: "kragero-naturstein", title: "Kragerø Naturstein", description: "Professional website for a Norwegian natural stone supplier.",    href: "/en/prosjekter/kragero-naturstein", image: null,                               video: "/videos/projects/krageroVid-web.mp4", placeholder: "#161613",  tag: "WordPress / SEO",       year: "2025" },
        { id: "nora-marketing",     title: "Nora Marketing",     description: "Marketing agency website focused on conversions.",               href: "/en/prosjekter/nora-marketing",     image: null,                               video: "/videos/projects/noraVid-web.mp4", placeholder: "#141318",  tag: "React / Headless CMS", year: "2025" },
      ]
    : [
        { id: "holidaze",           title: "Holidaze",           description: "Moderne bookingplattform for ferieboliger med interaktive kart.", href: "/prosjekter/holidaze",              image: "/images/projects/holidazeHome.png", video: null,                                  placeholder: "#131313",  tag: "React / TypeScript",     year: "2024" },
        { id: "kragero-naturstein", title: "Kragerø Naturstein", description: "Profesjonell nettside for en norsk natursteinleverandør.",        href: "/prosjekter/kragero-naturstein",    image: null,                               video: "/videos/projects/krageroVid-web.mp4", placeholder: "#161613",  tag: "WordPress / SEO",       year: "2025" },
        { id: "nora-marketing",     title: "Nora Marketing",     description: "Markedsføringsbyrå-nettside med fokus på konverteringer.",        href: "/prosjekter/nora-marketing",        image: null,                               video: "/videos/projects/noraVid-web.mp4", placeholder: "#141318",  tag: "React / Headless CMS", year: "2025" },
      ];
