      ...
      <div className="container mx-auto px-6 md:px-10">
        ...
        <div className="why-cards-grid">
          {cards.map((card: { title: string; description: string }, idx: number) => (
            ...
            >
              {/* Number */}
              <span className="shrink-0 text-[#635f5a] text-xs font-medium tracking-[0.15em] group-hover:text-[#c5f135] transition-colors duration-400 mt-0.5 md:w-10">
                {numbers[idx]}
              </span>
              ...
              {/* Description */}
              <p className="text-[#635f5a] text-sm leading-relaxed md:max-w-[340px] md:text-right">
                {card.description}
              </p>
            </div>
          ))}
