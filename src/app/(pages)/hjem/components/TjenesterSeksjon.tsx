          ...
          {services.map((svc) => (
            ...
            >
              <div className="flex items-center gap-5 md:gap-8">
                {/* Index number */}
                <span className="text-[10px] text-[#635f5a]/50 font-mono tracking-widest w-6 shrink-0 transition-colors duration-300 group-hover:text-[#c5f135]/60">
                  {svc.index}
                </span>
                <h3
              ...
              <div className="flex items-center gap-4">
                <span
                  className={`hidden md:block text-xs tracking-widest uppercase font-medium transition-colors duration-250 ${
                    hovered === svc.id ? "text-[#635f5a]" : "text-[#635f5a]/40"
                  }`}
                >
                  {svc.tag}
                </span>
