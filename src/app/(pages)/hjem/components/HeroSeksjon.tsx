          ...
          <div className="flex flex-col items-center md:items-start w-full">
            <AnimatedListItem delay={300}>
              {currentLanguage === "no" ? (
                <>
                  Med{" "}
                  <AnimatedKeyword delay={350} highlightColor="text-cyan-300">
                    sterk kompetanse
                  </AnimatedKeyword>{" "}
                  innen{" "}
                  <AnimatedKeyword delay={400} highlightColor="text-cyan-300">
                    nettsider
                  </AnimatedKeyword>
                  ,{" "}
                  <AnimatedKeyword delay={450} highlightColor="text-cyan-300">
                    applikasjoner
                  </AnimatedKeyword>{" "}
                  og{" "}
                  <AnimatedKeyword delay={500} highlightColor="text-cyan-300">
                    SEO
                  </AnimatedKeyword>{" "}
                  får du løsninger som gir resultater.
                </>
              ) : (
                <>
                  With{" "}
                  ...
                  , you get solutions that deliver results.
                </>
              )}
            </AnimatedListItem>
            <AnimatedListItem delay={550}>
              {currentLanguage === "no" ? (
                <>
                  Fra{" "}
                  <AnimatedKeyword delay={600} highlightColor="text-cyan-300">
                    idé
                  </AnimatedKeyword>{" "}
                  og{" "}
                  <AnimatedKeyword delay={650} highlightColor="text-cyan-300">
                    konseptutvikling
                  </AnimatedKeyword>{" "}
                  til{" "}
                  <AnimatedKeyword delay={700} highlightColor="text-cyan-300">
                    design
                  </AnimatedKeyword>
                  ,{" "}
                  <AnimatedKeyword delay={750} highlightColor="text-cyan-300">
                    programmering
                  </AnimatedKeyword>{" "}
                  og{" "}
                  <AnimatedKeyword delay={800} highlightColor="text-cyan-300">
                    lansering
                  </AnimatedKeyword>{" "}
            ...
            <div className="flex flex-col md:flex-row justify-center gap-4 md:gap-8 mt-8 w-full max-w-xl">
              ...
              <Link
                href={getLocalizedPath("/tjenester") as any}
