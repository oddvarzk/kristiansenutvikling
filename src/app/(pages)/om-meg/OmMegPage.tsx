        ...
        <div className="container mx-auto max-w-7xl">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 md:gap-20 items-start">
            ...
            <div className="story-photo">
              ...
              >
                ...
                <div className="absolute inset-0 flex flex-col items-center justify-center gap-3">
                  ...
                  <span className="section-label text-[#635f5a]/60">
            ...
            <div className="story-bio flex flex-col justify-center gap-6 md:pt-4">
              ...
              <p className="text-[#635f5a] text-base leading-relaxed" style={{ fontFamily: "Satoshi, sans-serif" }}>
                {om.story.bio2}
              </p>
              <p className="text-[#635f5a] text-base leading-relaxed" style={{ fontFamily: "Satoshi, sans-serif" }}>
                {om.story.bio3}
        ...
        <div className="container mx-auto max-w-7xl">
          ...
          <div className="values-list">
            {om.values.items.map((item, idx) => (
              ...
              >
                <span className="shrink-0 text-[#635f5a] text-xs font-medium tracking-[0.15em] group-hover:text-[#c5f135] transition-colors duration-300 mt-0.5 md:w-10">
                  {item.number}
                </span>
                <h3
                ...
                <p className="text-[#635f5a] text-sm leading-relaxed md:max-w-[360px] md:text-right" style={{ fontFamily: "Satoshi, sans-serif" }}>
                  {item.text}
                </p>
              </div>
            ))}
        ...
        <div className="container mx-auto max-w-7xl">
          ...
          <div className="stack-grid flex flex-wrap gap-3 md:gap-4">
            {techStack.map((tech) => (
              ...
              >
                <span className="w-1 h-1 rounded-full bg-[#635f5a] group-hover:bg-[#c5f135] transition-colors duration-300 shrink-0" />
                {tech}
              </span>
            ))}
          </div>
      ...
      >
        <div className="container mx-auto max-w-7xl">
          <div className="max-w-3xl">
            ...
            <p className="cta-sub text-[#635f5a] text-base md:text-lg leading-relaxed mb-10" style={{ fontFamily: "Satoshi, sans-serif" }}>
              {om.cta.sub}
            </p>
